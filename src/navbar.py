   ...
   html.Div(className="d-flex flex-column flex-lg-row align-items-center justify-content-center justify-content-md-between", children=[
       html.Div(className="d-flex flex-column flex-lg-row align-items-center", children=[
        ...
        html.Div(className="ms ms-lg-5 d-xl d-xl-block", children=[
            html.H5("Armed Conflicts Location And Events Data Report: Europe - 2023", className="title-header"),
            html.H6("Statistical Analysis Report And Data Visualization", className="subtitle-header text-muted text-center text-md-start")
        ]),
     ]),
                ...
                dmc.Tooltip(
                    ...
                    children=[
                        dbc.Button(href="/a-propos-de-l-application", className="btn", children=[
                            DashIconify(icon="flat-color-icons:about", width=30), " About AnalyticsPaper"
